...
bool UPDF_ReaderBPLibrary::Read_PDF_Windows(TMap<UTexture2D*, FVector2D>& OutPages, bool bUseDebug, FString InPath, TArray<uint8> InBytes, FString InPDF_Pass, double Sampling)
{	
