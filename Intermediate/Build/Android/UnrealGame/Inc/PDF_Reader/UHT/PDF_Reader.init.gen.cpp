...
void EmptyLinkFunctionForGeneratedCodePDF_Reader_init() {}
	...
	FORCENOINLINE UPackage* Z_Construct_UPackage__Script_PDF_Reader()
	{
		if (!Z_Registration_Info_UPackage__Script_PDF_Reader.OuterSingleton)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				(UObject* (*)())Z_Construct_UDelegateFunction_PDF_Reader_DelegateHttpResponse__DelegateSignature,
			};
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferPackage_UPackage__Script_PDF_Reader(Z_Construct_UPackage__Script_PDF_Reader, TEXT("/Script/PDF_Reader"), Z_Registration_Info_UPackage__Script_PDF_Reader, CONSTRUCT_RELOAD_VERSION_INFO(FPackageReloadVersionInfo, 0xAA6F5381, 0xBD51EBF8));
